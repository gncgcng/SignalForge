...
assert.match(app, /Confidence reflects setup alignment after historical calibration\. It is not a guaranteed win rate\./);
...
assert.match(service, /indicators: \{ \.\.\.\(signal\.indicators \|\| \{\}\), signalQuality: undefined, confidenceCalibration: undefined \}/);

...
export const appConfig = {
  appName: "SignalForge",
  debugBuildMarker: "SIGNAL-DESK-001",
  ...
  manualScan: {
    ...
    batchSize: Math.max(1, Number(process.env.MANUAL_SCAN_BATCH_SIZE || 50)),
    concurrency: Math.min(2, Math.max(1, Number(process.env.MANUAL_SCAN_CONCURRENCY || 2))),
